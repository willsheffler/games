...
class Star:
   __slots__ = ('pos', 'vel', 'brightness', 'speed', 'position_history')
...
def update(dt):
   ...
   warp_factor = (MIN_WARP_FACTOR + (warp_factor - MIN_WARP_FACTOR) * DRAG**dt)
   ...
   stars = [star for star in stars if BOUNDS.collidepoint(star.end_pos)]
